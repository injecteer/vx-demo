...
flowchart BT
	...
	app[fas:fa-bolt app]
	demo-core-ext[fas:fa-link +	grails-datastore-gorm-hibernate5	groovy	groovy-dateutil	groovy-json	groovy-yaml]:::ext
	demo-core[fas:fa-book demo-core]
	domain-ext[fas:fa-link +	h2	jackson-databind	log4j-over-slf4j	logback-classic	vertx-core	vertx-hazelcast	vertx-health-check	vertx-web]:::ext
	domain-ext[fas:fa-link spock-core]:::ext
